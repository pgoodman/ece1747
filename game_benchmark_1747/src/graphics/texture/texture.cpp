...
int LoadBitmap(char *filename, int *w, int *h) {
  ...
  *h = infoheader.biHeight;
  ...
  if ((i = fread(infoheader.data, infoheader.biWidth * infoheader.biHeight * 3,
                 1, file)) != 1) {
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, 3, infoheader.biWidth, infoheader.biHeight, 0,
