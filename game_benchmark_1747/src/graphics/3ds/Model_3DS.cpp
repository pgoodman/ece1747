...
void Model_3DS::MaterialChunkProcessor(Sint32 length, Sint32 findex,
                                       int matindex) {
  ChunkHeader h;
...
void Model_3DS::MaterialNameChunkProcessor(Sint32 length, Sint32 findex,
                                           int matindex) {
  // move the file pointer to the beginning of the main
  // chunk's data findex + the size of the header
  fseek(bin3ds, findex, SEEK_SET);
...
void Model_3DS::DiffuseColorChunkProcessor(Sint32 length, Sint32 findex,
                                           int matindex) {
  ChunkHeader h;
...
void Model_3DS::FloatColorChunkProcessor(Sint32 length, Sint32 findex,
                                         int matindex) {
  float r;
  float g;
  float b;
...
void Model_3DS::IntColorChunkProcessor(Sint32 length, Sint32 findex,
                                       int matindex) {
  Uint8 r;
  Uint8 g;
  Uint8 b;
...
void Model_3DS::TextureMapChunkProcessor(Sint32 length, Sint32 findex,
                                         int matindex) {
  ChunkHeader h;
...
void Model_3DS::MapNameChunkProcessor(Sint32 length, Sint32 findex,
                                      int matindex) {
  char name[80];
...
void Model_3DS::ObjectChunkProcessor(Sint32 length, Sint32 findex,
                                     int objindex) {
  ChunkHeader h;
...
void Model_3DS::TriangularMeshChunkProcessor(Sint32 length, Sint32 findex,
                                             int objindex) {
  ChunkHeader h;
...
void Model_3DS::VertexListChunkProcessor(Sint32 length, Sint32 findex,
                                         int objindex) {
  Uint16 numVerts;
...
void Model_3DS::TexCoordsChunkProcessor(Sint32 length, Sint32 findex,
                                        int objindex) {
...
void Model_3DS::FacesDescriptionChunkProcessor(Sint32 length, Sint32 findex,
                                               int objindex) {
  ChunkHeader h;
...
void Model_3DS::FacesMaterialsListChunkProcessor(Sint32 length, Sint32 findex,
                                                 int objindex,
                                                 int subfacesindex) {
  ...
  Objects[objindex].MatFaces[subfacesindex].subFaces = new GLushort[numEntries
      * 3];
  ...
  for (i = 0; i < numEntries * 3; i += 3) {
    ...
    Objects[objindex].MatFaces[subfacesindex].subFaces[i] = Objects[objindex]
        .Faces[Face * 3];
