...
class AStar {
 ...
 public:
  ...
  void setSecondMatrix(int n2, int m2, char **second_matrix, int offx,
                       int offy);
   ...
   */
  PointStack* findPathAStar(int startx, int starty, int stopx, int stopy,
  ...
  PointStack *findPathTh(int startx, int starty, int stopx, int stopy,
                         int explore_size);
};
