...
const char AI_state_names[6][20] = { "basic", "exploring", "quest", "food",
...
const char AI_actions[7][10] = { "none", "up", "down", "left", "right", "eat",
    "attack" };
...
class PlayerAI {
 ...
 public:
  ...
  bool findNearObject(int *x, int *y, int distance, int type, int min_value,
                      int max_value);
