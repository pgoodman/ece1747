...
plot "/tmp/proc_time_nomerge.dat" using (($2+$3+$4+$5)/4.) title 'Average Unmerged' smooth csplines linecolor rgb "blue", \
     "/tmp/proc_time_merge.dat" using (($2+$3+$4+$5)/4.) title 'Average Merged' smooth csplines linecolor rgb "green"
