...
gnuplot -e "out_file='$1_num_req.png'" -e "duration=2000" -e "qbegin=300" -e "qend=1300" plot_proc_time.p
#gnuplot -e "out_file='$1_num_req.png'" -e "duration=2000" -e "qbegin=300" -e "qend=1300" plot_.p
