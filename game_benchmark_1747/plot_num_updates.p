...
plot "/tmp/num_update.dat" using 1:2 title 'Thread 1' smooth csplines linecolor rgb "red", \
     "/tmp/num_update.dat" using 1:3 title 'Thread 2' smooth csplines linecolor rgb "green", \
     "/tmp/num_update.dat" using 1:4 title 'Thread 3' smooth csplines linecolor rgb "blue", \
     "/tmp/num_update.dat" using 1:5 title 'Thread 4' smooth csplines linecolor rgb "orange", \
